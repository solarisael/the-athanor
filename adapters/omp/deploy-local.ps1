...
$GuardedEnvironment = @(
  ...
  "ATHANOR_HOST_ENDPOINTS", "ATHANOR_HOST_HOUSE_ID", "ATHANOR_HOST_TOKEN", "ATHANOR_VAULT_ROOT",
  "ATHANOR_PG_WSL", "PG_BIN_DIR", "SOLARISAEL_GIGA_ENABLED",
  "SOLARISAEL_SUBSTRATE_TEST_DATABASE_URL", "DATABASE_URL", "PGHOST", "PGPORT",
  "PGDATABASE", "PGUSER", "PGPASSWORD", "SOLARISAEL_HOUSE_RUST",
