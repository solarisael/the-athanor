...
export function registerSolarisaelTools(pi, release) {
  ...
  registerHouseTool(pi, {
    ...
    parameters: z.object({
      ...
      triggerContext: z.string().optional().describe("lesson kinds: when the lesson applies and should be retrieved."),
      exampleText: z.string().optional().describe("writing/design lessons: example text."),
      languageKeys: z.array(z.string()).optional().describe("coding/project lessons: language slugs used for retrieval eligibility."),
      technologyKeys: z.array(z.string()).optional().describe("coding/project lessons: technology slugs used for retrieval eligibility."),
  ...
  registerHouseTool(pi, {
    ...
    parameters: z.object({
      ...
      patch: z.object({
        ...
        triggerContext: z.string().optional().describe("When the lesson applies and should be retrieved."),
        ...
        condition: z.array(z.string()).optional().describe("Replacement native OMP regex patterns; [] disarms regex matching."),
  ...
  registerHouseTool(pi, {
    ...
    parameters: z.object({
      ...
      tag: z.string().optional().describe("Exact lesson tag filter."),
      ...
      triggerOnly: z.boolean().optional().describe("Return only lessons with a regex or AST trigger."),
    ...
    async execute(_toolCallId, params, signal, _onUpdate, ctx) {
      ...
      const result = await requestRustDomain("lesson_query", {
        ...
        ...(params.triggerOnly ? { triggerOnly: true } : {}),
        ...(ids.length ? { ids } : {}),
      }, signal);
      return {
        isError: !result.ok,
  ...
  registerHouseTool(pi, {
    ...
    parameters: z.object({
      ...
      group: z.string().optional().describe("Optional document group."),
      values: z.record(z.string(), z.unknown()).optional().describe("Structured JSON design values."),
      body: z.string().optional().describe("Contract prose; sent through stdin."),
      provenance: z.record(z.string(), z.unknown()).optional().describe("Structured JSON evidence and extraction provenance."),
  ...
  registerHouseTool(pi, {
    ...
    parameters: z.object({
      ...
      lessonBodies: z.array(z.string()).describe("Complete verbatim lesson bodies required by the matching LESSON_MAP sections. Bare IDs and summaries are not delivery."),
