...
The newline-delimited JSON wire protocol, version 1. This crate carries the shapes that cross a process boundary, and converts them into `house-core` requests.
