...
fn validation_owner(operation: &str) -> (&'static str, &'static str) {
    match operation {
        ...
        "giga_event_ingest" => ("src/giga/event_ingest.rs", "giga_event_ingest"),
        "giga_conversation_ingest" => (
            "src/giga/conversation_ingest.rs",
            "giga_conversation_ingest",
        ),
        "giga_event_claim" => ("src/giga/event_claim.rs", "giga_event_claim"),
        "giga_event_finish" => ("src/giga/event_finish.rs", "giga_event_finish"),
        "giga_event_replay" => ("src/giga/event_replay.rs", "giga_event_replay"),
        "giga_queue_maintenance" => ("src/giga/queue.rs", "giga_queue_maintenance"),
        "giga_promote" => ("src/giga/promotion.rs", "giga_promote"),
        "giga_tool_promote" => ("src/giga/tool_promotion.rs", "giga_tool_promote"),
        "giga_candidate_list" => ("src/giga/candidate_list.rs", "giga_candidate_list"),
        "giga_review" => ("src/giga/review.rs", "giga_review"),
        "giga_tool_review" => ("src/giga/tool_review.rs", "giga_tool_review"),
        "giga_health" => ("src/giga/health.rs", "giga_health"),
